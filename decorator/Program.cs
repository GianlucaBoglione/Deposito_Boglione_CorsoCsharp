...
// 3. Decorator: classe astratta che implementa IComponent e incapsula un IComponent interno
...
public class ConcreteDecoratorA : Decorator
{
    ...
    {
        Console.WriteLine("ConcreteDecoratorA: preoperazione");
        base.Operation();  // chiama Operation() sul componente interno
        Console.WriteLine("ConcreteDecoratorA: postoperazione");
    }
}
